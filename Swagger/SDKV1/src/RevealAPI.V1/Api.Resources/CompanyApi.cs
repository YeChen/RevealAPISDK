...
namespace RevealAPI.V1.Api.Resources
{
    ...
    public interface ICompanyApi : IApiAccessor
    {
        ...
        ApiResponse<List<Company>> CompanyGetWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<List<Company>> CompanyGetAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Company>>> CompanyGetAsyncWithHttpInfo ();
    ...
    public partial class CompanyApi : ICompanyApi
    {
        ...
        /// <returns></returns>
        public CompanyApi(RevealAPI.V1.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<List<Company>> localVarResponse = CompanyGetWithHttpInfo();
        ...
        /// <exception cref="RevealAPI.V1.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Company&gt;</returns>
        public ApiResponse< List<Company> > CompanyGetWithHttpInfo ()
        {

            var localVarPath = "/api/company";
            ...
            return new ApiResponse<List<Company>>(localVarStatusCode,
                ...
                (List<Company>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<Company>)));
        }
        ...
        /// <exception cref="RevealAPI.V1.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;Company&gt;</returns>
        public async System.Threading.Tasks.Task<List<Company>> CompanyGetAsync ()
        {
             ApiResponse<List<Company>> localVarResponse = await CompanyGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="RevealAPI.V1.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;Company&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Company>>> CompanyGetAsyncWithHttpInfo ()
        {
