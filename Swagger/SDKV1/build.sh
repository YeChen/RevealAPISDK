...
${nuget_cmd} install src/RevealAPI.V1/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/RevealAPI.V1.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/RevealAPI.V1.dll \
-recurse:'src/RevealAPI.V1/*.cs' \
-doc:bin/RevealAPI.V1.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/RevealAPI.V1.dll was created successfully"
fi
