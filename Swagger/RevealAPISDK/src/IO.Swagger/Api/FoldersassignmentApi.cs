...
namespace IO.Swagger.Api
{
    ...
    public interface IFoldersassignmentApi : IApiAccessor
    {
        ...
        ApiResponse<PaginatedOfIEnumerableOfAssignmentBatchFolder> AssignmentFoldersV2GetWithHttpInfo (int? caseId, string filterOption = null, int? start = null, int? count = null, AssignmentBatchQuery body = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<PaginatedOfIEnumerableOfAssignmentBatchFolder> AssignmentFoldersV2GetAsync (int? caseId, string filterOption = null, int? start = null, int? count = null, AssignmentBatchQuery body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PaginatedOfIEnumerableOfAssignmentBatchFolder>> AssignmentFoldersV2GetAsyncWithHttpInfo (int? caseId, string filterOption = null, int? start = null, int? count = null, AssignmentBatchQuery body = null);
        /// <summary>
        /// Get assignment folders
        /// </summary>
        /// <remarks>
    ...
    public partial class FoldersassignmentApi : IFoldersassignmentApi
    {
        ...
        /// <returns></returns>
        public FoldersassignmentApi(Configuration configuration = null)
        {
        ...
        /// <param name="body">Run with one filter with filterType error to run original batch call (optional)</param>
        /// <returns>PaginatedOfIEnumerableOfAssignmentBatchFolder</returns>
        public PaginatedOfIEnumerableOfAssignmentBatchFolder AssignmentFoldersV2Get (int? caseId, string filterOption = null, int? start = null, int? count = null, AssignmentBatchQuery body = null)
        {
        ...
        /// <param name="body">Run with one filter with filterType error to run original batch call (optional)</param>
        /// <returns>ApiResponse of PaginatedOfIEnumerableOfAssignmentBatchFolder</returns>
        public ApiResponse< PaginatedOfIEnumerableOfAssignmentBatchFolder > AssignmentFoldersV2GetWithHttpInfo (int? caseId, string filterOption = null, int? start = null, int? count = null, AssignmentBatchQuery body = null)
        {
            // verify the required parameter 'caseId' is set
            if (caseId == null)
            ...
            if (caseId != null) localVarPathParams.Add("caseId", Configuration.ApiClient.ParameterToString(caseId)); // path parameter
            if (filterOption != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "filterOption", filterOption)); // query parameter
            ...
            return new ApiResponse<PaginatedOfIEnumerableOfAssignmentBatchFolder>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PaginatedOfIEnumerableOfAssignmentBatchFolder) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PaginatedOfIEnumerableOfAssignmentBatchFolder)));
        }
        ...
        /// <param name="body">Run with one filter with filterType error to run original batch call (optional)</param>
        /// <returns>Task of PaginatedOfIEnumerableOfAssignmentBatchFolder</returns>
        public async System.Threading.Tasks.Task<PaginatedOfIEnumerableOfAssignmentBatchFolder> AssignmentFoldersV2GetAsync (int? caseId, string filterOption = null, int? start = null, int? count = null, AssignmentBatchQuery body = null)
        {
        ...
        /// <param name="body">Run with one filter with filterType error to run original batch call (optional)</param>
        /// <returns>Task of ApiResponse (PaginatedOfIEnumerableOfAssignmentBatchFolder)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PaginatedOfIEnumerableOfAssignmentBatchFolder>> AssignmentFoldersV2GetAsyncWithHttpInfo (int? caseId, string filterOption = null, int? start = null, int? count = null, AssignmentBatchQuery body = null)
        {
            // verify the required parameter 'caseId' is set
            if (caseId == null)
                throw new ApiException(400, "Missing required parameter 'caseId' when calling FoldersassignmentApi->AssignmentFoldersV2Get");
