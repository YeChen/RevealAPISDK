...
namespace IO.Swagger.Api
{
    ...
    public partial class FieldsApi : IFieldsApi
    {
        ...
        /// <returns></returns>
        public FieldsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< PaginatedOfListOfField > FieldV2GetAllFieldsWithHttpInfo (int? caseId, bool? includeNotImportable = null, bool? includeSpecial = null, int? start = null, int? count = null)
        {
            ...
            if (caseId != null) localVarPathParams.Add("caseId", Configuration.ApiClient.ParameterToString(caseId)); // path parameter
            if (includeNotImportable != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "includeNotImportable", includeNotImportable)); // query parameter
            ...
            return new ApiResponse<PaginatedOfListOfField>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PaginatedOfListOfField) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PaginatedOfListOfField)));
        }
