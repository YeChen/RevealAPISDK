...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DateTimeSearchClause :  IEquatable<DateTimeSearchClause>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimeSearchClause" /> class.
        /// </summary>
        ...
        public DateTimeSearchClause(SearchClauseType Type = default(SearchClauseType), string FieldName = default(string), string Gte = default(string), string Gt = default(string), string Eq = default(string), string Lte = default(string), string Lt = default(string), string Item = default(string))
        {
            this.Type = Type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DateTimeSearchClause {\n");
        ...
        {
            return this.Equals(input as DateTimeSearchClause);
        }

        /// <summary>
        /// Returns true if DateTimeSearchClause instances are equal
        /// </summary>
        /// <param name="input">Instance of DateTimeSearchClause to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateTimeSearchClause input)
        {
            if (input == null)
                return false;
