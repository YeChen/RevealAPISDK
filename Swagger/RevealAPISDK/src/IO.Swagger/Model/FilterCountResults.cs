...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FilterCountResults :  IEquatable<FilterCountResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterCountResults" /> class.
        /// </summary>
        /// <param name="Count">Count.</param>
        /// <param name="FilterReferenceId">FilterReferenceId.</param>
        public FilterCountResults(int? Count = default(int?), string FilterReferenceId = default(string))
        {
            this.Count = Count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FilterCountResults {\n");
        ...
        {
            return this.Equals(input as FilterCountResults);
        }

        /// <summary>
        /// Returns true if FilterCountResults instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterCountResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterCountResults input)
        {
            if (input == null)
                return false;
