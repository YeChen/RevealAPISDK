...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FilterCountRequestDTO :  IEquatable<FilterCountRequestDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterCountRequestDTO" /> class.
        /// </summary>
        /// <param name="FilterClauses">FilterClauses.</param>
        /// <param name="SearchContext">SearchContext.</param>
        public FilterCountRequestDTO(List<FilterClauseRequestDTO> FilterClauses = default(List<FilterClauseRequestDTO>), CountQueryCriteria SearchContext = default(CountQueryCriteria))
        {
        ...
        public List<FilterClauseRequestDTO> FilterClauses { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FilterCountRequestDTO {\n");
        ...
        {
            return this.Equals(input as FilterCountRequestDTO);
        }

        /// <summary>
        /// Returns true if FilterCountRequestDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterCountRequestDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterCountRequestDTO input)
        {
            if (input == null)
                return false;
