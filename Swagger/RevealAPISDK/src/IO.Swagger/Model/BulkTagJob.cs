...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkTagJob :  IEquatable<BulkTagJob>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkTagJob" /> class.
        /// </summary>
        ...
        public BulkTagJob(int? Id = default(int?), string Name = default(string), int? CreatedByUserId = default(int?), JobStatus? Status = default(JobStatus?), int? NumberOfDocuments = default(int?), DateTime? CreatedDateTime = default(DateTime?), DateTime? StartedDateTime = default(DateTime?), DateTime? CompletedDateTime = default(DateTime?), bool? IsDeleted = default(bool?), string JobInfoMessage = default(string))
        {
            this.Id = Id;
            this.Name = Name;
        ...
        {
            return this.Equals(input as BulkTagJob);
        }

        /// <summary>
        /// Returns true if BulkTagJob instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkTagJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkTagJob input)
        {
            if (input == null)
                return false;
