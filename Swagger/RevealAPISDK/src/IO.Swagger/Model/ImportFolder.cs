...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportFolder :  IEquatable<ImportFolder>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportFolder" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ImportFolder);
        }

        /// <summary>
        /// Returns true if ImportFolder instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportFolder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportFolder input)
        {
            if (input == null)
                return false;
