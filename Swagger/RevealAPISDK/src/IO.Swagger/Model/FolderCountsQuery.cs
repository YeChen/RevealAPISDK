...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FolderCountsQuery :  IEquatable<FolderCountsQuery>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FolderCountsQuery" /> class.
        /// </summary>
        /// <param name="Requests">Contains root folders and their types for folder counts call.</param>
        ...
        public FolderCountsQuery(List<FolderIdCountsRequest> Requests = default(List<FolderIdCountsRequest>), string QueryString = default(string), SearchQueryType? QueryType = default(SearchQueryType?), string SortByString = default(string), bool? IgnoreDocumentSecurity = default(bool?), List<int?> SearchProfileIds = default(List<int?>))
        {
        ...
        /// <summary>
        /// Contains root folders and their types for folder counts call
        /// </summary>
        /// <value>Contains root folders and their types for folder counts call</value>
        [DataMember(Name="requests", EmitDefaultValue=false)]
        public List<FolderIdCountsRequest> Requests { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FolderCountsQuery {\n");
        ...
        {
            return this.Equals(input as FolderCountsQuery);
        }

        /// <summary>
        /// Returns true if FolderCountsQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of FolderCountsQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FolderCountsQuery input)
        {
            if (input == null)
                return false;
