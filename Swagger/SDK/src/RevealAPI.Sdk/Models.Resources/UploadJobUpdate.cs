...
namespace RevealAPI.Sdk.Models.Resources
{
    ...
    public partial class UploadJobUpdate :  IEquatable<UploadJobUpdate>, IValidatableObject
    {
        ...
        public UploadJobUpdate(string name = default(string), string custodian = default(string), string description = default(string), S3Manifest manifest = default(S3Manifest), bool? duplicateDocuments = default(bool?), UploadJobWorkFlow? workFlow = default(UploadJobWorkFlow?))
        {
            this.Name = name;
