...
namespace RevealAPI.Sdk.Api.Resources
{
    ...
    public partial class FieldProfilesApi : IFieldProfilesApi
    {
        ...
        /// <returns></returns>
        public FieldProfilesApi(RevealAPI.Sdk.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< PaginatedOfListOfFieldProfile > FieldProfileV2GetWithHttpInfo (int? caseId, int? userId = null, int? start = null, int? count = null)
        {
            ...
            return new ApiResponse<PaginatedOfListOfFieldProfile>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PaginatedOfListOfFieldProfile) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PaginatedOfListOfFieldProfile)));
        }
        ...
        public ApiResponse< PaginatedOfListOfProfileFieldInclusionItem > FieldProfileV2GetDefaultFieldsWithHttpInfo (int? caseId, int? id, int? start = null, int? count = null)
        {
            ...
            return new ApiResponse<PaginatedOfListOfProfileFieldInclusionItem>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PaginatedOfListOfProfileFieldInclusionItem) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PaginatedOfListOfProfileFieldInclusionItem)));
        }
        ...
        public ApiResponse< PaginatedOfListOfManagedField > FieldProfileV2GetFieldsWithHttpInfo (int? caseId, int? id, int? userId = null, bool? combineDateTimeFields = null, bool? includeSpecial = null, int? start = null, int? count = null)
        {
            ...
            if (id != null) localVarPathParams.Add("id", this.Configuration.ApiClient.ParameterToString(id)); // path parameter
            if (userId != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "userId", userId)); // query parameter
            if (combineDateTimeFields != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "combineDateTimeFields", combineDateTimeFields)); // query parameter
            ...
            return new ApiResponse<PaginatedOfListOfManagedField>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PaginatedOfListOfManagedField) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PaginatedOfListOfManagedField)));
        }
        ...
        public ApiResponse<Object> FieldProfileV2SetDefaultFieldsDisplayOrderWithHttpInfo (int? caseId, int? id, bool? overwriteUserProfiles = null, List<ManagedFieldDisplayOrdering> body = null)
        {
            ...
            if (caseId != null) localVarPathParams.Add("caseId", this.Configuration.ApiClient.ParameterToString(caseId)); // path parameter
            if (id != null) localVarPathParams.Add("id", this.Configuration.ApiClient.ParameterToString(id)); // path parameter
            if (overwriteUserProfiles != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "overwriteUserProfiles", overwriteUserProfiles)); // query parameter
            if (body != null && body.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(body); // http body (model) parameter
            }
