...
namespace RevealAPI.Sdk.Api.Resources
{
    ...
    public partial class DocsApi : IDocsApi
    {
        ...
        /// <returns></returns>
        public DocsApi(RevealAPI.Sdk.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< List<DateHistogramSearchResult> > DocumentV2GetDateHistogramResultsWithHttpInfo (int? caseId, DateHistogramSearchCriteria body = null)
        {
            ...
            return new ApiResponse<List<DateHistogramSearchResult>>(localVarStatusCode,
                ...
                (List<DateHistogramSearchResult>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<DateHistogramSearchResult>)));
        }
        ...
        public ApiResponse< DocumentFieldCountResponse > DocumentV2GetDocumentCountsForFieldWithHttpInfo (int? caseId, string fieldName = null, int? returnCountsGreaterThan = null, bool? sortByValue = null, bool? sortAscending = null, DocumentQuery body = null)
        {
            ...
            if (returnCountsGreaterThan != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "returnCountsGreaterThan", returnCountsGreaterThan)); // query parameter
            if (sortByValue != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "sortByValue", sortByValue)); // query parameter
            if (sortAscending != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "sortAscending", sortAscending)); // query parameter
            if (body != null && body.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(body); // http body (model) parameter
            }
            ...
            return new ApiResponse<DocumentFieldCountResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (DocumentFieldCountResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DocumentFieldCountResponse)));
        }
        ...
        public ApiResponse< List<DocumentFieldCountResponse> > DocumentV2GetDocumentCountsForField2WithHttpInfo (int? caseId, DocumentFieldCountQuery body = null)
        {
            ...
            return new ApiResponse<List<DocumentFieldCountResponse>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<DocumentFieldCountResponse>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<DocumentFieldCountResponse>)));
        }
        ...
        public ApiResponse< DocumentQueryResults2 > DocumentV2QueryDocsWithHttpInfo (int? caseId, DocumentQuery body = null)
        {
            ...
            return new ApiResponse<DocumentQueryResults2>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (DocumentQueryResults2) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DocumentQueryResults2)));
        }
