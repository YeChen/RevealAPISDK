...
namespace RevealAPI.Sdk.Api.Resources
{
    ...
    public partial class RevealaiApi : IRevealaiApi
    {
        ...
        /// <returns></returns>
        public RevealaiApi(RevealAPI.Sdk.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> RevealAiPassThroughPostFormWithHttpInfo (string path, List<KeyValuePairOfStringAndStringValues> formData = null)
        {
            ...
            if (path != null) localVarPathParams.Add("path", this.Configuration.ApiClient.ParameterToString(path)); // path parameter
            if (formData != null) localVarFormParams.Add("formData", this.Configuration.ApiClient.ParameterToString(formData)); // form parameter
