...
namespace RevealAPI.Sdk.Api.Resources
{
    ...
    public partial class ImageSetsApi : IImageSetsApi
    {
        ...
        /// <returns></returns>
        public ImageSetsApi(RevealAPI.Sdk.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< PaginatedOfListOfImageSet > ImageSetV2GetListWithHttpInfo (int? caseId, int? start = null, int? count = null)
        {
            ...
            return new ApiResponse<PaginatedOfListOfImageSet>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PaginatedOfListOfImageSet) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PaginatedOfListOfImageSet)));
        }
