...
namespace RevealAPI.Sdk.Api.Resources
{
    ...
    public partial class ViewApi : IViewApi
    {
        ...
        /// <returns></returns>
        public ViewApi(RevealAPI.Sdk.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< string > ViewRouteGetReviewDocumentViewerUrlWithHttpInfo (int? caseId, int? docIndex = null, int? gridPageIndex = null, int? assignmentFolderId = null, DocumentQuery body = null)
        {
            ...
            if (caseId != null) localVarPathParams.Add("caseId", this.Configuration.ApiClient.ParameterToString(caseId)); // path parameter
            if (docIndex != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "docIndex", docIndex)); // query parameter
            if (gridPageIndex != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "gridPageIndex", gridPageIndex)); // query parameter
            if (assignmentFolderId != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "assignmentFolderId", assignmentFolderId)); // query parameter
