...
${nuget_cmd} install src/RevealAPI.Sdk/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/RevealAPI.Sdk.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/RevealAPI.Sdk.dll \
-recurse:'src/RevealAPI.Sdk/*.cs' \
-doc:bin/RevealAPI.Sdk.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/RevealAPI.Sdk.dll was created successfully"
fi
